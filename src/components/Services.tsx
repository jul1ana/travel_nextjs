  ...
  return (
    <section className="bg-[#211e3b]">
      <div className="mx-auto max-w-[1440px] px-6 py-20 lg:px-20 lg:py-48 3xl:px-0">
        <div className="flex flex-col items-center space-y-16 lg:space-y-32">
          {/* CONTENT */}
          ...
          <div className="flex flex-col gap-8 lg:flex-row">
            <div className="border border-[#312e49] font-semibold flex flex-col items-center py-12 px-2 space-y-4 rounded-md hover:bg-[#2e2a50] hover:border-[#2e2a50]">
              <Image src="/sicon1.png" alt="Serviços TI" width={140} height={140} />
              <h4 className="text-white">Manage IT Services</h4>
              <p className="text-[#9a95c0] w-4/5 text-center">Sed perspicias unde omnis natus error volute</p>
            ...
            <div className="border border-[#312e49] font-semibold flex flex-col items-center py-12 px-2 space-y-4 rounded-md hover:bg-[#2e2a50] hover:border-[#2e2a50]">
              ...
              <h4 className="text-white">Product Engineering</h4>
              <p className="text-[#9a95c0] w-4/5 text-center">Sed perspicias unde omnis natus error volute</p>
              <Link href="/" className="text-[#9a95c0] uppercase flex items-center gap-4">
                learn more
                <FaArrowRight size={14} />
